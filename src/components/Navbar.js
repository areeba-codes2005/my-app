      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <div className={`form-check form-check-inline text-${props.mode==='light'?'dark':'light'}`}>
            <input className="form-check-input border-secondary" onClick={props.togglemode} type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1"/>
            <label className="form-check-label" htmlFor="inlineRadio1">{props.mod === 'white' ?'Enable Dark Gray' : 'Enable Light Mode'}</label>
          </div>
          <div className={`form-check form-check-inline text-${props.mode==='light'?'dark':'light'}`}>
            <input className="form-check-input border-secondary" onClick={props.togglmode} type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2"/>
